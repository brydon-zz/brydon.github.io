...
<br /><?if($admin==1){?><a href='publish.php' title='Create an Article'>Create</a><br /><?}?><a id='logout'>Logout</a><?}else{?><a href="signup.php" title="Sign Up">Sign Up</a> / <a id="loginA" title="Login">Login</a><br />
<div id="loginform">
